...
const cardClasses =
  "grid w-full max-w-[250px] grid-cols-[50px_1fr] grid-rows-[1fr_1fr] p-2 text-left no-underline bg-[rgb(220,221,252)] transition duration-200 ease-in-out hover:bg-[rgb(207,208,253)]";

const iconClasses = "row-span-2 h-10 w-10 rounded-full p-[0.3rem] text-darkcolor";
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 select-none">
        <a className={cardClasses} href="mailto:ramiplatero11@gmail.com">
          ...
          <h4 className="text-[0.9rem] font-semibold text-black">Mail me at</h4>
          <h4 className="text-[0.9rem] font-semibold text-blueviolet2">
        ...
        >
          ...
          <h4 className="text-[0.9rem] font-semibold text-black">
            Contact me via
          </h4>
          <h4 className="text-[0.9rem] font-semibold text-blueviolet2">
            LinkedIn
